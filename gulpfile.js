...
function devExt() {
  return src(`${options.paths.src.js}/external/**/*`).pipe(
    dest(`${options.paths.dist.js}/external`)
  );
}

function copyAlpine() {
  return src("node_modules/alpinejs/dist/module.esm.min.js").pipe(dest(`${options.paths.dist.js}/external`)); // Копируем в dist/js/external
}
...
exports.default = series(
  ...
  parallel(devStyles, devScripts, devExt, copyAlpine, devImages, devFonts, devThirdParty, devHTML), //Run All tasks in parallel
...
exports.prod = series(
  ...
  parallel(prodStyles, prodScripts, devExt, copyAlpine, prodImages, prodHTML, prodFonts, prodThirdParty), //Run All tasks in parallel
  buildFinish
);
